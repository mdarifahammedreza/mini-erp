      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {hasPermission('sales.create') && (
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white rounded-xl text-sm font-semibold transition-all duration-200 shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 hover:scale-[1.02] active:scale-[0.98]"
          >
      ...
      {!isLoading && sales.length === 0 ? (
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-16 flex flex-col items-center text-center space-y-4 shadow-sm">
          ...
          {hasPermission('sales.create') && !debouncedSearch && (
            <button
              onClick={() => navigate('/sales/create')}
              className="mt-2 inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-600 to-amber-600 text-white rounded-lg text-sm font-semibold transition-all hover:scale-[1.02] shadow-md shadow-orange-500/20"
            >
              <Plus className="w-4 h-4" />
              Record First Sale
            </button>
